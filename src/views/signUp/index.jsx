...
const SignupForm = (props) => {
    ...
    const [userAvatar, setUserAvatarImg] = useState(null)
    const [showAlertAvatarError, setshowAlertAvatarError] = useState(false)
    ...
    const sendUserAvatar = async (userId) => {
        try {
                    ...
                    <Form className="container" onSubmit={formik.handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <Field
                                ...
                                name="avatarImg"
                                type="file"
                                onChange={(e) => setUserAvatarImg(e.target.files[0])}
                            />
                        </div>
